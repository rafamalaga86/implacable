...
class CreateExercisesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('exercises', function (Blueprint $table) {
            ...
            $table->enum('category', Exercise::getCategoryValues());
        ...
        $data = [
            ...
            [2, 'Bombardero en picado','calisthenics','https://cdn.shopify.com/s/files/1/1430/2722/files/dive-bomber-push-ups_large.jpg?v=1522853303'],
